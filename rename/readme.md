To run this simple rename script you must have a lookup.txt document that includes a unique identifier in the first column and the information you want to replace it with in the second column. 
